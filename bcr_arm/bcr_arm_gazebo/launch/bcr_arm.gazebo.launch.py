...
def generate_launch_description():
    ...
    bcr_arm_gazebo_share = get_package_share_directory("bcr_arm_gazebo")
    bcr_arm_gazebo_models = os.path.join(bcr_arm_gazebo_share, "models")

    current_gz_resource_path = os.environ.get("GZ_SIM_RESOURCE_PATH", "")
    # Add package roots and explicit model directories so model:// URIs resolve.
    new_paths = [parent_dir, bcr_arm_gazebo_models]
